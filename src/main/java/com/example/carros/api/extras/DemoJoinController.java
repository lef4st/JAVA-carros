package com.example.carros.api.extras;

import com.example.carros.api.users.Role;
...
interface JoinRepository extends JpaRepository<User, Long> {
    ...
    @Query(value = "SELECT new com.example.carros.api.extras.UsuarioRoleDTO(u.login,u.email,r.nome) FROM user u inner join u.roles r")
